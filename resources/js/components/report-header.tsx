    ...
    return (
        <div className="mb-8 border-b-2 border-primary pb-4 print:border-black print:text-black">
            <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1 print:text-black">Komplek Perumdam III/4, Tunggul Hitam, Kota Padang</p>
                <p className="text-sm text-muted-foreground print:text-black">Telp: 0822-8714-0724 | Email: info@nabilrental.com</p>
