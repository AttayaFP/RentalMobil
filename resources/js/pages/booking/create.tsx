                                ...
                                <Card>
                                    <CardHeader>
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <CardTitle>Form Pemesanan Mobil</CardTitle>
                                    ...
                                    <CardContent className="space-y-5">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input value={selectedMobil?.plat_mobil || ''} readOnly className="bg-muted font-semibold" placeholder="-" />
                                        </div>
                                        <div className="grid gap-4 sm:grid-cols-2">
                                            <div className="space-y-2">
                                                <Label htmlFor="tglmulai">Tanggal Rental</Label>
                                                <Input
                                                    id="tglmulai"
                                                    type="date"
                                                    value={data.tglmulai}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input value={data.lama_sewa ? `${data.lama_sewa} Hari` : ''} readOnly className="bg-muted font-semibold" placeholder="-" />
                                        </div>
                                        <div className="space-y-2">
                                            <Label>Harga Rental</Label>
                                            <Input value={data.harga ? formatCurrency(data.harga) : ''} readOnly className="bg-muted font-semibold" placeholder="-" />
                                        </div>

                                        {/* Total Pembayaran */}
                                        <div className="space-y-2">
                                            <Label>Total Pembayaran</Label>
                                            <Input value={data.total_bayar ? formatCurrency(data.total_bayar) : ''} readOnly className="bg-muted font-bold text-primary text-lg" placeholder="-" />
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
