...
Route::middleware('guest')->group(function () {
    ...
    Route::post('forgot-password/verify-email', [DirectPasswordResetController::class, 'verifyEmail'])
        ->name('password.verify-email');

    Route::post('forgot-password/reset-direct', [DirectPasswordResetController::class, 'store'])
